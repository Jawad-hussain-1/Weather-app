...
export const WeatherIcons = {
  ...
  "12n":"/react-weather-app/icons/airpollution.svg",
  "12d":"/react-weather-app/icons/airpollution.svg",
...
function App() {
  ...
  const fetchWeather = async (e) => {
    ...
    const response = await Axios.get(
      `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=3a78af70593ce47b0bfa3f1d8df10916`,
      `http://api.openweathermap.org/data/2.5/air_pollution?lat={lat}&lon={lon}&appid={3a78af70593ce47b0bfa3f1d8df10916}`,
    );
